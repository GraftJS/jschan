...
ClientSession.prototype._createNewStream = function newStream(chan, parent, cb) {
  var headers = {};

  headers['libchan-ref'] = chan.id;

  if (parent) {
    headers['libchan-parent-ref'] = parent.id;
  } else {
    headers['libchan-parent-ref'] = '0';
  }
...
ClientSession.prototype._createDuplexStream = function(parent) {
